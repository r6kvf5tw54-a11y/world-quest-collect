  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium cursor-pointer transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground shadow-elevated hover:brightness-110 active:scale-[0.985]",
        accent: "bg-accent text-accent-foreground shadow-elevated hover:brightness-105 active:scale-[0.985]",
        quiet: "border border-border bg-surface text-foreground hover:bg-secondary",
        onDark: "bg-inverse text-ink hover:bg-inverse/90 active:scale-[0.985]",
      },
      size: {
        ...
        icon: "h-9 w-9",
        xl: "h-14 rounded-2xl px-6 text-[15px]",
